...
<head>
    ...
    <title>Shorts | Raakdatri Indonesia</title>
...
<body>
    ...
    <section class="card" id="product-card">
        ...
        <div class="products">
            ...
            $result = $koneksi->query("SELECT * FROM products WHERE kategori = 'shorts'");
            ...
            ?>
            <div class="row">
                <img src="img/Short/product 2.png" alt="">
                ...
                <div class="price">
                    <h4>regular denim shorts</h4>
                    <p>IDR 500,000.00</p>
                </div>
            </div>

            <div class="row">
                <img src="img/Short/product 6.png" alt="">
                <div class="product-text">
                    <h5>-25%</h5>
                </div>

                <div class="price">
                    <h4>regular fit cotton chino shorts</h4>
                    <p>IDR 400,000.00</p>
                </div>
            </div>

            <div class="row">
                <img src="img/Short/product 9.png" alt="">

                <div class="price">
                    <h4>Linen-blend Shorts</h4>
                    <p>IDR 699,000.00</p>
                </div>
            </div>

            <div class="row">
                <img src="img/Short/product 15.png" alt="">
            ...
            <div class="row">
                <img src="img/Short/product 10.png" alt="">

                <div class="price">
                    <h4>regular fit nylon chargo shorts</h4>
                    <p>IDR 400,000.00</p>
                </div>
            </div>

            <div class="row">
                <img src="img/Short/product 12.png" alt="">
                <div class="product-text">
                    <h5>New</h5>
                </div>
                <div class="product-text1">
