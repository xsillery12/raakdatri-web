...
<head>
    ...
    <title>Profile | Raakdatri Indonesia</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="address.php">Shipping Address</a></li>
    ...
    <div class="profile-info">
        ...
        <div class="user-details">
            <p><strong>Nama:</strong> Muhammad Daffa Fachreza</p>
            <p><strong>Email:</strong> daffa123@gmail.com</p>
            <p><strong>Date of Birth:</strong> October 12, 2002</p>
