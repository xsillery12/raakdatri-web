...
<head>
    ...
    <title>My Wishlist | Raakdatri Indonesia</title>
                ...
                <table width="100%">
                    <tbody>
                        <tr>
                            ...
                            <td class="long-text">Airwalk Tifton Men's Sneaker</td>
                            <td>IDR 150.000,00</td>
                            <td>
                                <div class="number-input">
                                    <button class="minus">-</button>
                                    <input type="text" value="1" min="0" id="quantity" readonly>
