...
<head>
    ...
    <title>Accessories | Raakdatri Indonesia</title>
...
<body>
    ...
    <section class="card" id="product-card">
        ...
        <div class="products">
            ...
            $result = $koneksi->query("SELECT * FROM products WHERE kategori = 'accessories'");
            ...
            ?>
            <div class="row">
                <img src="img/Accessories/beanie 1.png" alt="">
                ...
                <div class="price">
                    <h4>Russel Athletic Knit Beanie</h4>
                    <p>IDR 400,000.00</p>
                </div>
            </div>

            <div class="row">
                <img src="img/Accessories/dompet 1.png" alt="">
                <div class="product-text">
                    <h5>-25%</h5>
                </div>
            ...
            <div class="row">
                <img src="img/Accessories/kaos kaki 1.png" alt="">

                <div class="price">
                    <h4>Butterfly Sports Socks</h4>
                    <p>IDR 130,000.00</p>
                </div>
            </div>

            <div class="row">
                <img src="img/Accessories/cap 1.png" alt="">

                <div class="price">
                    <h4>Cotton Twill Cap</h4>
                    <p>IDR 300,000.00</p>
                </div>
            </div>

            <div class="row">
                <img src="img/Accessories/tas cowok 1.png" alt="">
            ...
            <div class="row">
                <img src="img/Accessories/tas 1.png" alt="">
                <div class="product-text">
                    <h5>New</h5>
                </div>
                <div class="product-text1">
                ...
                <div class="price">
                    <h4>HandBag Checked</h4>
                    <p>IDR 350,000.00</p>
                </div>
            </div>

            <div class="row">
                <img src="img/Accessories/scarfs 1.png" alt="">

                <div class="price">
                    <h4>Tie-Dye Bandana Scarfs</h4>
                    <p>IDR 250,000.00</p>
                </div>
            </div>

            <div class="row">
                <img src="img/Accessories/kacamataa 1.png" alt="">

                <div class="price">
                    <h4>Sport Sunglasses</h4>
                    <p>IDR 200,000.00</p>
                </div>
            </div>
        </div>
