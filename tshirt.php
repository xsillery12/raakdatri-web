...
<head>
    ...
    <title>T-Shirt | Raakdatri Indonesia</title>
...
<body>
    ...
    <section class="card" id="product-card">
        ...
        <div class="products">
            ...
            $result = $koneksi->query("SELECT * FROM products WHERE kategori = 't-shirt'");
            ...
            ?>
            <div class="row">
                <img src="img/T-shirt/product 3.png" alt="">
                ...
                <div class="price">
                    <h4>Nike Big Swoosh T-Shirt</h4>
                    <p>IDR 450,000.00</p>
                </div>
            </div>

            <div class="row">
                <img src="img/T-shirt/product 4.png" alt="">
                <div class="product-text">
                    <h5>-25%</h5>
                </div>

                <div class="price">
                    <h4>Nike Sportswear T-Shirt</h4>
                    <p>IDR 450,000.00</p>
                </div>
            </div>

            <div class="row">
                <img src="img/T-shirt/product 5.png" alt="">

                <div class="price">
                    <h4>Champion Crewneck T-Shirt</h4>
                    <p>IDR 350,000.00</p>
                </div>
            </div>

            <div class="row">
                <img src="img/T-shirt/product 6.png" alt="">

                <div class="price">
                    <h4>Champion Script Logo T-Shirt</h4>
                    <p>IDR 350,000.00</p>
                </div>
            </div>

            <div class="row">
                <img src="img/T-shirt/product 7.png" alt="">

                <div class="price">
                    <h4>Lacoste Breathable T-Shirt</h4>
                    <p>IDR 550,000.00</p>
                </div>
            </div>

            <div class="row">
                <img src="img/T-shirt/product 8.png" alt="">
                <div class="product-text">
                    <h5>New</h5>
                </div>
                <div class="product-text1">
                ...
                <div class="price">
                    <h4>Under Armour Meridian Tee</h4>
                    <p>IDR 250,000.00</p>
                </div>
            </div>
        </div>
